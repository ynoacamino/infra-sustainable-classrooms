...
export const updateCourseFormFields: Field<
  keyof z.infer<typeof updateCourseFormSchema>
>[] = [
  {
    name: 'title',
    label: 'Course Title',
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder:
      'e.g. Deep dive into JavaScript programming language features...',
    description:
      'Enter a detailed description of the course (10-300 characters).',
  },
  {
    name: 'imageUrl',
    ...
    description:
      'Enter the URL of the course image (optional, 5-500 characters).',
  },
];
