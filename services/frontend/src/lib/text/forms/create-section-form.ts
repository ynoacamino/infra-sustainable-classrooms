...
export const createSectionFormFields: Field<
  keyof z.infer<typeof createSectionFormSchema>
>[] = [
  {
    name: 'title',
    label: 'Section Title',
  ...
  },
  {
    ...
    placeholder: 'e.g. 1',
    description:
      'Enter the order of the section in the course (optional, will be auto-numbered if not set).',
  },
];
