...
export const updateSectionFormFields: Field<keyof z.infer<typeof updateSectionFormSchema>>[] = [
  {
    name: "title",
    label: "Section Title",
    type: "text",
  ...
  },
  {
    ...
    type: "number",
    placeholder: "e.g. 2",
    description: "Enter the order of the section in the course (optional, will update the order if set).",
  },
];
