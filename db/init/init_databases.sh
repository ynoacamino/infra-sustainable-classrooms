...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "infrastructure_db" -c "CREATE DATABASE codelab_db;"
...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname=codelab_db < /docker-entrypoint-initdb.d/codelab_db.sql
