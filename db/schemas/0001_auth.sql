...
-- Tabla de intentos de autenticación (para rate limiting)
...
DROP INDEX IF EXISTS idx_backup_codes_used_at;
DROP INDEX IF EXISTS idx_sessions_user_id;
DROP INDEX IF EXISTS idx_sessions_token;
DROP INDEX IF EXISTS idx_sessions_expires_at;
DROP INDEX IF EXISTS idx_sessions_is_active;
DROP INDEX IF EXISTS idx_auth_attempts_identifier;
DROP INDEX IF EXISTS idx_auth_attempts_ip_address;
